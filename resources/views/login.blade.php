      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-white text-black" style="border-radius: 1rem;"> 
          <div class="card-body p-5 text-center">
              ...
              <img class="rounded-circle z-depth-3 float-left" alt="Julia's Laundry Logo" src="{{ asset('images/logo_min.jpg') }}" data-holder-rendered="true" width="120" height="140">
              <h5 class="fw-bold mb-5 text-uppercase text-md-left">Julia's Laundry Management System Version 2</h2>
...
>>>>>>> b511ab65dcd5646ff8d8baf4523e319e47ffc5a7
